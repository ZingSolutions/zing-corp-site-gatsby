                        ...
                        <div className="casestudy-info-content" style={styles}>
                            <div className="content-container" >
                                <div className="casestudy-outer">
                                    <h2>Interested in integrating Twilio to your business services?</h2>
                                    <p>if you're unable to see your services in the page above, have no fear! There's good change we're able to work with them Contact us to get in touch with a member of the team to find out more..
                                        &nbsp;<a href="http://192.168.10.128:8001/integration/" className="link-design">Contact us</a>
                                    </p>
                                </div>
                            </div>
                        </div>
