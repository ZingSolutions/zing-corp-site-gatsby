        ...
        >
          <div className="content-container">
            <div className="home-page-content">
              ...
              <p>
                To Help Our Customers Discover True Value Through Twilio’s Cloud
        ...
        <section className="section-our-values">
          <div className="content-container">
            <div className="new-content-header">
              <i>
                <img src="/images/zing-icon.svg" alt="" />
              </i>
            ...
            <ul>
              <li>
                ...
                <span></span>
                <p>
                  Driven to learn. We’re fascinated by the process of discovery
                  and how to unlock value. This is reflected in our continuous
                  investigation into new techniques and technologies.
                </p>
              </li>
              <li>
                <h3>Relentless</h3>
                ...
                <p>
                  ...
                  question the perceived norm. Our customers aren’t just looking
                  for another app. They want a development partner to help them
                  disrupt and challenge their markets.
                </p>
              </li>
              <li>
                <h3>Energetic</h3>
        ...
        <section className="section-our-story">
          <div className="content-container">
            ...
            <div className="ourstory-img">
              <Img fluid={data.ourStory.childImageSharp.fluid} />
            ...
            <div className="ourstory-info text-area-1">
              ...
              <p>
                Zing is part of the Sputnik Group of Companies, formed after the
                MBO of <a href="https://prospectsoft.com">ProspectSoft</a>, by{" "}
                <a href="https://linkedin.com/in/andrewardron/">
                  Andrew Ardron
                </a>{" "}
                and backed by{" "}
                <a href="https://mavencp.com/">Maven Private Equity</a> in 2017.
              </p>
              <p>
                <a href="https://prospectsoft.com">ProspectSoft</a>, is the
                leading provider of SaaS CRM systems designed for the Wholesale,
            ...
            <div className="ourstory-info text-area-2">
              <p>
                ...
                Francisco,{" "}
                <a href="https://linkedin.com/in/jonathanpbrewer/">Jonathan</a>{" "}
              ...
              <p>
                ...
                <a href="https://linkedin.com/in/jhucker">Julian Hucker</a>, the
                co-founder of Esendex, joined as Business Development Director
                to help drive the next stage of Zing’s growth.
              </p>
              <p>
                In Jan 2020 Zing Dev Limited was set up as a business within the
                Project Sputnik Group with backing from{" "}
...
export const query = graphql`
  query {
    hero: file(relativePath: { eq: "about-us-page.jpg" }) {
      childImageSharp {
        fluid(maxWidth: 4096) {
